...
struct Bitter : Module
{
    ...
    Bitter()
    {
        ...
        configParam(Bitter::BIT_1, 0.0, 2.0, 2.0, "Bit 1");
        configParam(Bitter::BIT_2, 0.0, 2.0, 2.0, "Bit 2");
        configParam(Bitter::BIT_3, 0.0, 2.0, 2.0, "Bit 3");
        configParam(Bitter::BIT_4, 0.0, 2.0, 2.0, "Bit 4");
        configParam(Bitter::BIT_5, 0.0, 2.0, 2.0, "Bit 5");
        configParam(Bitter::BIT_6, 0.0, 2.0, 2.0, "Bit 6");
        configParam(Bitter::BIT_7, 0.0, 2.0, 2.0, "Bit 7");
        configParam(Bitter::BIT_8, 0.0, 2.0, 2.0, "Bit 8");
