...
struct Ctrl : Module
{
    ...
    Ctrl()
    {
        ...
        configParam(Ctrl::KNOB_1, -5.0, 5.0, 0.0, "Knob 1");
        configParam(Ctrl::KNOB_2, -5.0, 5.0, 0.0, "Knob 2");
        configParam(Ctrl::KNOB_3, -5.0, 5.0, 0.0, "Knob 3");
        configParam(Ctrl::KNOB_4, -5.0, 5.0, 0.0, "Knob 4");
        configParam(Ctrl::KNOB_5, -5.0, 5.0, 0.0, "Knob 5");
        configParam(Ctrl::KNOB_6, -5.0, 5.0, 0.0, "Knob 6");
        configParam(Ctrl::KNOB_7, -5.0, 5.0, 0.0, "Knob 7");
        configParam(Ctrl::KNOB_8, -5.0, 5.0, 0.0, "Knob 8");
