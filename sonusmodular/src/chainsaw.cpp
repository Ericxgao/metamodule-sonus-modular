...
struct Chainsaw : Module
{
    ...
    Chainsaw()
    {
        ...
        configParam(Chainsaw::OCTAVE, -3.0, 3.0, 0.0, "Octave");
        configParam(Chainsaw::OSC1_SHAPE, -1.0, 1.0, 0.0, "Osc 1 Shape");
        configParam(Chainsaw::OSC1_TUNE, -1.0, 1.0, 0.0, "Osc 1 Tune");
        configParam(Chainsaw::OSC2_SHAPE, -1.0, 1.0, 0.0, "Osc 2 Shape");
        configParam(Chainsaw::OSC2_TUNE, -1.0, 1.0, 0.0, "Osc 2 Tune");
        configParam(Chainsaw::OSC3_SHAPE, -1.0, 1.0, 0.0, "Osc 3 Shape");
        configParam(Chainsaw::OSC3_TUNE, -1.0, 1.0, 0.0, "Osc 3 Tune");
        configParam(Chainsaw::ALIGN, 0.0, 1.0, 0.0, "Align");
...
void Chainsaw::process(const ProcessArgs &args)
{
    ...
    if (std::roundf(params[ALIGN].getValue()) != 0.0 || inputs[CV_ALIGN].getVoltage() != 0)
    {
