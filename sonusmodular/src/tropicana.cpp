...
struct Tropicana : Module
{
    ...
    Tropicana()
    {
        ...
        configParam(Tropicana::OCTAVE, -3.0, 3.0, 0.0, "Octave");
        configParam(Tropicana::OSC1_BEATS, -10.0, 10.0, 0.0, "Osc 1 Beats");
        configParam(Tropicana::OSC1_VCA, -1.0, 1.0, 0.0, "Osc 1 VCA");
        configParam(Tropicana::OSC2_BEATS, -10.0, 10.0, 0.0, "Osc 2 Beats");
        configParam(Tropicana::OSC2_VCA, -1.0, 1.0, 0.0, "Osc 2 VCA");
        configParam(Tropicana::OSC3_BEATS, -10.0, 10.0, 0.0, "Osc 3 Beats");
        configParam(Tropicana::OSC3_VCA, -1.0, 1.0, 0.0, "Osc 3 VCA");
        configParam(Tropicana::OSC4_BEATS, -10.0, 10.0, 0.0, "Osc 4 Beats");
        configParam(Tropicana::OSC4_VCA, -1.0, 1.0, 0.0, "Osc 4 VCA");
        configParam(Tropicana::OSC5_BEATS, -10.0, 10.0, 0.0, "Osc 5 Beats");
        configParam(Tropicana::OSC5_VCA, -1.0, 1.0, 0.0, "Osc 5 VCA");

        configParam(Tropicana::OFFSET, -2.0, 2.0, 0.0, "Offset");
        configParam(Tropicana::HARM_MODE, 0.0, 2.0, 2.0, "Harmonic Mode");
    }
